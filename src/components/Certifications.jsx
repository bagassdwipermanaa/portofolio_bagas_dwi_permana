...
const Certifications = () => {
  const certifications = [
  {
    ...
    date: 'June 11, 2024',
    description: 'This certificate is awarded for participating in the Competence Day event held by SMK Telkom Jakarta as a representative in the Graphic Design Center category.',
    pdfLink: '#',
  ...
  },
  {
    ...
    description: 'Certificate of Completion awarded to Bagas Dwi Permana for completing "Build a WordPress Website on Hostinger: Web Design 101".',
    pdfLink: '#',
  ...
  },
  {
    ...
    issuer: 'Udemy',
    date: 'February 8, 2025',
    description: 'Certificate of Completion awarded to Bagas Dwi Permana for completing the "CSS Coding for Website Development" bootcamp for beginners.',
    pdfLink: '#',
  ...
  },
  {
    ...
    issuer: 'DQLab',
    date: 'October 9, 2024',
    description: 'This certificate is awarded to Bagas Dwi Permana for completing the "Guide to Learn SQL with AI" program offered by DQLab.',
    pdfLink: '#',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 font-space max-w-3xl mx-auto">
            Recognition of expertise and dedication in mastering the latest technologies in the world of web development.
          </p>
        </motion.div>
          ...
          {certifications.map((cert) => (
            ...
            >
              <div className={`p-6 md:p-8 relative`}>
                <div className={`absolute top-0 left-0 h-1 w-full bg-gradient-to-r ${cert.gradient}`}></div>
                <div className="flex items-center mb-4">
                    <div className={`p-3 bg-gradient-to-r ${cert.gradient} rounded-lg mr-4`}>
