...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      githubLink:
        'https://github.com/CodeWithBagas/uiux-esport-smktelkom',
      isPrivate: false,
    },
    {
      id: 3,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 font-space max-w-3xl mx-auto">
            A collection of projects that demonstrate skill and creativity in modern web development.
          </p>
        </motion.div>
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                  <div className="flex space-x-2 w-full">
                    ...
                    <Button
                      onClick={() => handleViewLink(project.githubLink, 'GitHub', project.isPrivate)}
                      size="sm"
                      variant="outline"
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className={`px-2 py-1 text-xs font-space font-medium rounded bg-gradient-to-r ${project.gradient} bg-opacity-20 text-white border border-white/20`}
                    >
                      {tech}
                    </span>
                  ))}
        ...
        >
          <div className="bg-gradient-to-r from-cyber-blue/10 to-cyber-purple/10 border border-cyber-blue/30 rounded-xl p-8 backdrop-blur-sm">
            <h3 className="text-2xl font-space font-bold text-white mb-4">Interested in my project?</h3>
