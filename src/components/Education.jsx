      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-white to-neutral-300 rounded-full mb-6"
          >
            <GraduationCap className="h-10 w-10 text-background" />
          </motion.div>

          <h2 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-neutral-200 to-white bg-clip-text text-transparent">
            Education Journey
          </h2>

          <div className="w-32 h-1 bg-gradient-to-r from-white via-neutral-300 to-white mx-auto mb-8 rounded-full"></div>
          ...
          {educationData.map((edu, index) => (
            ...
            >
              ...
              <div className="relative">
                ...
                {/* Content Card */}
                <div className="relative ml-8 md:ml-0 md:flex md:justify-center">
                  <motion.div
                    whileHover={{
                      scale: 1.02,
                      y: -5,
                    }}
                    className="w-full max-w-4xl bg-neutral-800/90 backdrop-blur-xl border border-neutral-700 rounded-2xl p-8 hover:border-neutral-600 transition-all duration-500 shadow-2xl"
                  >
                    {/* Header Section */}
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                      <div className="flex items-center space-x-4 mb-4 md:mb-0">
                        <div className="p-4 rounded-2xl bg-neutral-700/50 border border-neutral-600">
                      ...
                      <div className="grid gap-3">
                        {edu.achievements.map((achievement, idx) => (
                          <motion.div
                            ...
                            className="flex items-start space-x-3 p-4 bg-neutral-700/50 rounded-xl border border-neutral-600"
                          >
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="group relative text-center p-8 bg-neutral-800/90 backdrop-blur-xl border border-neutral-700 rounded-2xl hover:border-neutral-600 transition-all duration-500 shadow-xl overflow-hidden"
            >
              {/* Background Glow */}
              ...
              <div className="relative z-10 mb-4">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-neutral-700/50 rounded-2xl border border-neutral-600 mb-4">
